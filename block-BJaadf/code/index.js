...
let lowercaseFruits = fruits.map(x => x.toLowerCase())
// Convert all fruits name into uppercase and store in new array named uppercaseFruits
let uppercaseFruits = fruits.map(x => x.toUpperCase())
let numbers = [1, 2, [3, 4]];
...
let evenNumbers = numbersThree.flat(10).filter(x => {
    if(x % 2 == 0){
        return x
    }
})
// Find the index of 10 in numbersThree array
let random = numbersThree.flat(10)
random.findIndex(x=> x==10)
